...
const primaryColors = ref([
  {
    ...
    palette: {
      ...
      300: "#93c5fd", // blue-300
      400: "#60a5fa", // blue-400
      500: "linear-gradient(to right, #f59e0b, #ea580c)", // gradient amber-500 to orange-600
      600: "#2563eb", // blue-600
  ...
  },
  {
    ...
    palette: {
      ...
      300: "#87a2ce",
      400: "#678ac2",
      500: "#4e70a8", // gần với màu gốc sáng hơn
      600: "#3d5a8a",
      700: "#2d466b",
      800: "#1d3250",
      900: "#14223a",
...
function getPresetExt() {
  ...
  } else if (color.name === "gradient-blue-indigo") {
    return {
      semantic: {
        primary: {
          50: "#fffbeb",  // amber-50
...
function updateColors(type, color) {
  if (type === "primary") {
    ...
    document.body.setAttribute('data-primary', color.name);
          ...
          <button v-for="primaryColor of primaryColors" :key="primaryColor.name" type="button"
            :title="primaryColor.name" @click="updateColors('primary', primaryColor)" :class="[
              ...
              backgroundColor: `${primaryColor.name === 'noir'
                ? 'var(--text-color)'
                : primaryColor.name === 'gradient-blue-indigo'
                  ? 'transparent'
                  : primaryColor.palette['500']
                }`,
              background: `${primaryColor.name === 'gradient-blue-indigo'
