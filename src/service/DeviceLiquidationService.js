...
class DeviceLiquidationService {
  static API = "DeviceLiquidation";
  ...
  static async getAll(params = {}, formFilter) {
    const conditions = Object.entries(formFilter)
  ...
  static schema = yup.object({
    ...
    deviceLines: yup
      ...
      .of(
        yup.object({
          assetLiquidationPrice: yup
            .number()
            .typeError("Vui lòng nhập giá thanh lý")
            .required("Vui lòng nhập giá thanh lý")
            .min(0, "Giá thanh lý phải lớn hơn 0"),
          assetLiquidationFee: yup
            .number()
            .typeError("Vui lòng nhập phí thanh lý")
            .required("Vui lòng nhập phí thanh lý")
            .min(0, "Phí thanh lý phải lớn hơn 0"),
        })
      ),
  });
...
export default DeviceLiquidationService;
