<template>
  <Dialog
    ...
    modal
    :header="payload.id ? 'Cập nhật nhóm tài sản' : 'Thêm mới nhóm tài sản'"
    :style="{ width: '50rem' }"
  >
      ...
      <div class="p-4 rounded-lg shadow-sm">
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-4">
            <div class="flex flex-col gap-2">
              <label class="font-medium text-gray-700"
                >Mã nhóm<span class="text-red-500">*</span></label
              >
              <InputText
          ...
          <div class="col-span-8">
            <div class="flex flex-col gap-2">
              <label class="font-medium text-gray-700"
                >Tên nhóm<span class="text-red-500">*</span></label
              >
              <InputText
...
const saveData = async () => {
  try {
    const res = await AssetGroupService.save("AssetGroup", payload.value);
    if (payload.value.id) {
